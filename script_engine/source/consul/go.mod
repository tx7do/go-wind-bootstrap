module github.com/tx7do/go-wind-bootstrap/script_engine/source/consul

go 1.26.3

require (
	github.com/tx7do/go-scripts v0.0.6
	github.com/tx7do/go-scripts/source/consul v0.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/tx7do/go-scripts/source/consul => D:\GoProject\go-scripts\source\consul
