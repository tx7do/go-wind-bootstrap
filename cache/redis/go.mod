module github.com/tx7do/go-wind-bootstrap/cache/redis
...
require (
	...
	github.com/tx7do/go-wind-plugins/cache/redis v0.0.1
)
...
replace (
	...
	github.com/tx7do/go-wind-plugins/cache => D:\GoProject\go-wind-plugins\cache
)
