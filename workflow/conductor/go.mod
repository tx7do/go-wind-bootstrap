module github.com/tx7do/go-wind-bootstrap/workflow/conductor
...
require (
	...
	github.com/tx7do/go-wind-plugins/workflow/conductor v0.0.1
)
...
require (
	...
	github.com/conductor-sdk/conductor-go v1.9.0 // indirect
...
replace (
	...
	github.com/tx7do/go-wind-plugins/workflow => D:\GoProject\go-wind-plugins\workflow
)
