module github.com/tx7do/go-wind-bootstrap/transport/webtransport
...
require (
	...
	github.com/tx7do/go-wind-plugins/transport/webtransport v0.0.0-20260611060538-877fa5c566fc
)
