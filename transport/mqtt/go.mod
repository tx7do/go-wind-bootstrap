module github.com/tx7do/go-wind-bootstrap/transport/mqtt
...
require (
	...
	github.com/tx7do/go-wind-plugins/transport/mqtt v0.0.0-20260611060538-877fa5c566fc
)
...
require (
	...
	github.com/tx7do/go-wind-plugins/broker/mqtt v0.0.1 // indirect
