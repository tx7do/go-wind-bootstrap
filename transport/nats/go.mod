module github.com/tx7do/go-wind-bootstrap/transport/nats
...
require (
	...
	github.com/tx7do/go-wind-plugins/transport/nats v0.0.0-20260611060538-877fa5c566fc
)
...
require (
	...
	github.com/tx7do/go-wind-plugins/broker/nats v0.0.1 // indirect
