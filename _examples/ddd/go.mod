module github.com/tx7do/go-wind-bootstrap/_examples/ddd
...
require (
	...
	github.com/tx7do/go-wind-bootstrap/cache/local v0.0.0
	github.com/tx7do/go-wind-bootstrap/database/gorm v0.0.0
...
require (
	...
	github.com/tx7do/go-wind-plugins/transport/http/middleware/recovery v0.0.1 // indirect
	github.com/tx7do/go-wind-plugins/transport/http/middleware/requestid v0.0.1 // indirect
...
replace (
	...
	github.com/tx7do/go-wind-bootstrap/cache/local => ../../cache/local
	github.com/tx7do/go-wind-bootstrap/conf => ../../conf
	github.com/tx7do/go-wind-bootstrap/database/gorm => ../../database/gorm
