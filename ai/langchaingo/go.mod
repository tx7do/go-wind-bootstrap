module github.com/tx7do/go-wind-bootstrap/ai/langchaingo
...
require (
	...
	github.com/tx7do/go-wind-plugins/ai/langchaingo v0.0.1
)
...
replace (
	...
	github.com/tx7do/go-wind-plugins/ai => D:\GoProject\go-wind-plugins\ai
)
